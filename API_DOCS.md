...
| `GET /api/buses` | No | Filter by `routeId`, `travelDate`, `maxPrice`, `isAc`, `busType`, `departure` |
...
Common errors: `422 VALIDATION_ERROR`, `401 UNAUTHENTICATED`, `403 FORBIDDEN` or `CSRF_INVALID`, `404 ROUTE_NOT_FOUND`/`TRIP_NOT_FOUND`, `409 SEAT_UNAVAILABLE`, `409 CANCELLATION_CLOSED`.
